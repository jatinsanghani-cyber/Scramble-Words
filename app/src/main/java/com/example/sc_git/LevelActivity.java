...
public class LevelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle b) {
        ...
        ImageButton e = findViewById(R.id.btnEasy);
        ImageButton m = findViewById(R.id.btnMedium);
        ImageButton h = findViewById(R.id.btnHard);
        ImageButton x = findViewById(R.id.btnExtreme);
    ...
    private void check(String lvl) {
        if (prefs.getBoolean(category + "_" + lvl, false)) {
            open(lvl);
        } else {
            Toast.makeText(this, "Complete previous level", Toast.LENGTH_SHORT).show();
        }
    }
